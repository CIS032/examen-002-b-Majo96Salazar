 ...
 * @author majo_
 */
public class AgregarCuentaAhorro_1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarCuentaAhorro_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarCuentaAhorro_1().setVisible(true);
